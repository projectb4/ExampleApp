...
import android.widget.ImageView; //Para usar la imagen
import android.widget.QuickContactBadge; //Acceso a contactos


public class Controllerb4 extends AppCompatActivity
    ...
    private TextView mTitleElements; //Despliega títulos y demás textos
    private ImageView mImage; //Despliega imágenes
    private QuickContactBadge mContacts; //Despliega contactos
